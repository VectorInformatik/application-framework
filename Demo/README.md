...
* [Hello world basic](https://github.com/VectorInformatik/application-framework/tree/main/Demo/HelloVaf/HelloWorld)
* [Hello world extended](https://github.com/VectorInformatik/application-framework/tree/main/Demo/HelloVaf/HelloExtended)
...
* [COVESA Vehicle Signal Specification (VSS) support](https://github.com/VectorInformatik/application-framework/tree/main/Demo/VssDemo)
* [HVAC demo, prototyping with MICROSAR Adaptive](https://github.com/VectorInformatik/application-framework/tree/main/Demo/HvacDemo/MSRA/app-centric)
* [ADAS demo, prototyping with SIL Kit](https://github.com/VectorInformatik/application-framework/tree/main/Demo/AdasDemo/SilKit/app-centric)
* [ADAS demo, prototyping with MICROSAR Adaptive](https://github.com/VectorInformatik/application-framework/tree/main/Demo/AdasDemo/MSRA/app-centric)
...
* [HVAC demo, based on a given AUTOSAR Adaptive model](https://github.com/VectorInformatik/application-framework/tree/main/Demo/HvacDemo/MSRA/platform-centric)
* [ADAS demo, based on a given AUTOSAR Adaptive model](https://github.com/VectorInformatik/application-framework/tree/main/Demo/AdasDemo/MSRA/platform-centric)
...
* [HVAC demo, integration-centric](https://github.com/VectorInformatik/application-framework/tree/main/Demo/HvacDemo/MSRA/integration-centric)
